...
from dataset_schemas import (
    CuePrompts, CueRecord, DatasetRecord,
)
...
# Legacy schema for backwards compatibility with existing models.py interface
class MultipleChoiceOptions(PydanticModel):
    """Legacy schema for multiple choice options that matches existing models.py interface."""
